...
| **Option 1 - Local Store - Batteries for SenseCAP Solar Node P1** | You'll can purchase four of these 18650 cells locally, but you'll need to add a spring to each to ensure the connection if you decide to purchase the P1 model without GPS & Battery  | [Motion Power & Witt Supply Co.](https://mpandw.ca/products/eve-35v-18650-battery-cells-set-of-6-with-holders) |
