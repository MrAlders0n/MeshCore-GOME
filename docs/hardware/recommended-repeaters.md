...
!!! warning "Important SenseCAP Solar Node P1/P1 Pro Notes"
    ...
    **Do not accidentally buy SMA — you specifically need RP-SMA.**  
    ...
    Example of a [RP-SMA → N-Type coax cable](https://www.aliexpress.com/item/1005009837133596.html) - Make sure to choose the ```Color: N F WP to RP-SMA M``` and ```30CM``` long options
...
| **Option 1 - Local Store - Batteries for SenseCAP Solar Node P1** | You'll need four button-top 18650 cells if you decide to purchase the P1 model without GPS & Battery  | [Motion Power & Witt Supply Co.](https://mpandw.ca/products/eve-35v-18650-battery-cells-set-of-6-with-holders) |
...
^ If you're using the Makerfocus flat battery: This already includes a PCM, the VoltaicEnclosures PCM is an added safety measure. If you're using unprotected batteries (e.g., 18650 button top), then you will need to purchase a PCM.
